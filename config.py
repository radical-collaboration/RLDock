...
config = {
    ...
    'protein_wo_ligand' : '/homes/aclyde11/RLDock/resources/lactamase_wo_lignad.pdb',
    'ligand' : '/homes/aclyde11/RLDock/resources/lactamase_ligand.pdb',
    'oe_box' : '/homes/aclyde11/RLDock/resources/lacatamase.oeb',
    ...
    'max_steps' : 100,
    'decay' : 0.93, # ^25 = 0.001,
    'random_ligand_folder' :      '/homes/aclyde11/RLDock/resources/rligands',
    'random_ligand_folder_test' : '/homes/aclyde11/RLDock/resources/rligands_eval',
    'voxel_method' : 'C',
    'debug' : False
}
